...
Version  : 2.0.8
Release  : 50
URL      : https://cran.r-project.org/src/contrib/pkgdown_2.0.8.tar.gz
Source0  : https://cran.r-project.org/src/contrib/pkgdown_2.0.8.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712778169
...
/usr/lib64/R/library/pkgdown/tests/testthat/setup.R
