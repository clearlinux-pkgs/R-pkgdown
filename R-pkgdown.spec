...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1610474222
...
/usr/lib64/R/library/pkgdown/tests/testthat/assets/reference-fail/docs/reference/index.html
...
/usr/lib64/R/library/pkgdown/tests/testthat/test-init-meta.txt
...
/usr/lib64/R/library/pkgdown/tests/testthat/test-rd-example-out.txt
/usr/lib64/R/library/pkgdown/tests/testthat/test-rd-example.R
/usr/lib64/R/library/pkgdown/tests/testthat/test-rd-html-error.txt
/usr/lib64/R/library/pkgdown/tests/testthat/test-rd-html.R
/usr/lib64/R/library/pkgdown/tests/testthat/test-rd-html.txt
